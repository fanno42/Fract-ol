...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2016/09/26 11:24:07 by fanno             #+#    #+#             */
/*   Updated: 2016/09/29 13:14:40 by fanno            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	choose_fractal(t_env *e)
{
	if (ft_strcmp(e->fractal, "julia") == 0)
		...
		e->fractal = "yolo";
	else if (ft_strcmp(e->fractal, "yolo") == 0)
		e->fractal = "hello";
...
{
	if (key == KEY_UP || key == KEY_LEFT || key == KEY_DOWN ||
			key == KEY_RIGHT || key == KEY_MINUS || key == KEY_EQUAL)
		do_input(e, key);
	return (key);
}
